(function() {
  ...
  /**
   * Initiate tooltips (using Bootstrap's Tooltip)
   */
  ...
  /**
   * Autoresize ECharts charts when #main resizes
   */
    ...
    setTimeout(() => {
      new ResizeObserver(() => {
        select('.echart', true).forEach(echartEl => {
          if (echarts.getInstanceByDom(echartEl)) {
